...
class SpanishContentUserGroupTest {
    ...
    void setUp() {
        ...
        context.create().resource("/content/larasoft/us/es", "jcr:primaryType", "cq:Page");
        context.create().resource("/content/larasoft/us/es/test-page",
                "jcr:primaryType", "cq:Page");
        context.create().resource("/content/larasoft/us/es/test-page/jcr:content",
    ...
    void testSpanishContentStructure_Exists() {
        ...
        Resource esContent = context.resourceResolver().getResource("/content/larasoft/us/es");
        assertNotNull(esContent, "Spanish content root should exist");
        
        Resource testPage = context.resourceResolver().getResource("/content/larasoft/us/es/test-page");
        assertNotNull(testPage, "Spanish test page should exist");
        
        Resource pageContent = context.resourceResolver().getResource("/content/larasoft/us/es/test-page/jcr:content");
    ...
    void testEditorSpanishGroup_Requirements() {
        ...
        assertTrue(spanishPath.startsWith("/content/larasoft/us/es"),
    ...
    void testReviewerSpanishGroup_Requirements() {
        ...
        // 1. Should have read access to /content/larasoft/us/es
    ...
    void testEditorCanPublishApprovedContent() {
        ...
        String pagePath = "/content/larasoft/us/es/test-page-approved";
    ...
    void testEditorCannotPublishUnapprovedContent() {
        ...
        for (String state : nonApprovedStates) {
            String pagePath = "/content/larasoft/us/es/test-page-" + state.toLowerCase();
            context.create().resource(pagePath, "jcr:primaryType", "cq:Page");
            context.create().resource(pagePath + "/jcr:content",
                    "jcr:primaryType", "cq:PageContent",
                    "workflowState", state);
    ...
    void testWorkflowStateProperty_CanBeSet() {
        ...
        String pagePath = "/content/larasoft/us/es/test-page/jcr:content";
    ...
    void testWorkflowStates_AllStates() {
        ...
        for (String state : validStates) {
            String pagePath = "/content/larasoft/us/es/test-page-" + state;
            context.create().resource(pagePath, "jcr:primaryType", "cq:Page");
            context.create().resource(pagePath + "/jcr:content",
                    "jcr:primaryType", "cq:PageContent",
                    "workflowState", state);
    ...
    void testSpanishContentPath_Validation() {
        ...
        assertTrue(isSpanishContent("/content/larasoft/us/es/page1"));
        assertTrue(isSpanishContent("/content/larasoft/us/es/subfolder/page2"));
    ...
    private boolean isSpanishContent(String path) {
        return path != null && path.startsWith("/content/larasoft/us/es");
    }
}
